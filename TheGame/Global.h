...
const int g_PREDATORCOUNT = 3;		// Real number of predators. Must be more than 1.
...
const int m_DINOSAURSPEED = 80;
const int m_DINOSAURSLOWINGRADIUS = 100;

const int m_HERBIVIEWDISTANCE = 300;
const int m_PREDATORVIEWDISTANCE = 400;

const float g_SUFFER = 0.5;
